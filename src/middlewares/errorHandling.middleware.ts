...
export const errorHandlingMiddleware = (err: any, req: Request, res: Response, next: express.NextFunction) => {
  ...
  const isDev = env.BUILD_MODE === 'development';
  if (!isDev) delete responseError.stack
